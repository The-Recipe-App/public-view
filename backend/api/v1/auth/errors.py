...
def register_failed_otp_not_verified():
    """
    Raise when a register attempt is made without a verified OTP for the given challenge_id+email.
    Keeps the error message generic for security.
    """
